define([
    ...
    "keymaster"
], function(ToolbarView, Toolbar, key) {
    return {
        ...
        toggleSelectComponent(enable) {
            ...
            this.getCanvasBodyEl()[method]('mouseover', el, this.onHover)[method]('mouseout', el, this.onOut)[method]('click', el, this.onClick);
