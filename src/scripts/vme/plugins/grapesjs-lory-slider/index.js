define(['exports', 'module', '../../grapesjs/index', './components/index', './blocks'], function(exports, module, _grapesjs, _componentsIndex, _blocks) {
    'use strict';
    ...
    var _loadComponents = _interopRequireDefault(_componentsIndex);

    var _loadBlocks = _interopRequireDefault(_blocks);

    module.exports = _grapesjs2['default'].plugins.add('grapesjs-lory-slider', function(editor) {
        ...
        // Add components
        (0, _loadComponents['default'])(editor, options);

        // Add blocks
        (0, _loadBlocks['default'])(editor, options);
    });
});